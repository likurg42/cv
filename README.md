...
Меня зовут Николай и я очень хочу стать крутым Frontend Разработчиком. Я нахожу очень интересным создание веб приложений, изучение новых технологий и способы их применения в современном вебе. Также мне очень нравится воплощать соврменные адаптивные и интерактивные дизайны в жизнь. Моя цель это изучение frontend разработки для решения проблем интерактивности и доступности в приложениях и ui/ux для создания новых приятных впечатлений для пользователей!
